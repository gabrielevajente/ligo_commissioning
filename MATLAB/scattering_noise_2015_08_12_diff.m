...
channels = {'H1:CAL-DELTAL_EXTERNAL_DQ', ...
            ...
            'H1:SUS-MC1_M1_DAMP_L_IN1_DQ', ...
            'H1:SUS-MC1_M1_DAMP_P_IN1_DQ', ...
            'H1:SUS-MC1_M1_DAMP_Y_IN1_DQ', ...
            'H1:SUS-MC2_M1_DAMP_L_IN1_DQ', ...
            'H1:SUS-MC2_M1_DAMP_P_IN1_DQ', ...
            'H1:SUS-MC2_M1_DAMP_Y_IN1_DQ', ...
            'H1:SUS-MC3_M1_DAMP_L_IN1_DQ', ...
            'H1:SUS-MC3_M1_DAMP_P_IN1_DQ', ...
            'H1:SUS-MC3_M1_DAMP_Y_IN1_DQ', ...
            };
...
aux = zeros(data1(2).getLength(), numel(data)-1);
...
X = zeros(size(A,1), 3*size(A,2)+1);
for i=1:size(A,2)
    % add each channel together with its squared values
    X(:,3*i-2) = A(:,i);
    X(:,3*i-1) = A(:,i).^2;
    X(1:end-1,3*i) = diff(A(:,i));
    % and save the names for future reference
    cname{3*i-2} = aux_channels{i};
    cname{3*i-1} = [aux_channels{i} , '^2'];
    cname{3*i} = ['diff ' , aux_channels{i}];
end
