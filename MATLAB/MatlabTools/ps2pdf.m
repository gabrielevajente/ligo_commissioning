...
%    fprintf(rsp_fid, '-swindowXSize = !D.X_Size=%s\n', '');
%    fprintf(rsp_fid, '-swindowYSize = !D.Y_Size=%s\n', '');
%    fprintf(rsp_fid, '-sxstart = (1.5/5.0) * windowXSize %s\n', '');
%    fprintf(rsp_fid, '-systart = (0.5/3.0) * windowYSize %s\n', '');
%    fprintf(rsp_fid, '-sxsize = (2.0/5.0) * windowXSize %s\n', '');
%    fprintf(rsp_fid, '-sysize = (2.0/5.0) * windowYSize %s\n', '');
%    fprintf(rsp_fid, '-sxsize = (2.0/5.0) * windowXSize %s\n', '');
%    fprintf(rsp_fid, '-sthisPosition =%s\n', '[0.15, 0.15, 0.85, 085] ');
%    fprintf(rsp_fid, '-sTVIMAGE, image, POSITION = %s\n', 'thisPosition ');
   fclose(rsp_fid);
