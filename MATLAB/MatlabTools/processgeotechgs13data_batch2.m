...
dataDir = '/Volumes/GS-13 Batch 2/LIGO_DVD_2/';
...
refGS13.LV.SN = 676;
refGS13.LH.SN = 775;
testGS13.LV.SNs = 726:774;
testGS13.LH.SNs = 825:873;
...
for iGS13LV = testGS13.LV.SNs
    ...
    close(1:3)
    clear test ref tf coh freq l* files fileTag dataFolder
