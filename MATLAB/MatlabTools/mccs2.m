...
%
%   - required inputs-
%  signal_time_series   time series to analyze, 
...
%    [asd_sig, asd_resid, freq, fit] = sccs2(signal_time_series, time_series2, Ts);
%    [asd_sig, asd_resid, freq, fit] = sccs2(signal_time_series, time_series2, Ts, smooth_width);
%    [asd_sig, asd_resid, freq, fit] = sccs2(signal_time_series, time_series2, Ts, smooth_width, poly_fit_terms);
%
...
if (cols1 > 1)    % input1 is a row vector, change it
    if debugging; disp('flip sig chan'); end
