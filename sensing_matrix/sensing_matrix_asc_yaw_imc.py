...
filename = "asc_sensing_matrix_imc_yaw"

# where are you?
ifo = "H1" 

# list of excitation channels
excitations = ["SUS-MC1_M3_LOCK_P_EXC", "SUS-MC2_M3_LOCK_P_EXC", "SUS-MC3_M3_LOCK_P_EXC", "IMC-PZT_YAW_EXC"]
...
monitors = ["SUS-MC1_M3_WIT_Y_DQ", "SUS-MC2_M3_WIT_Y_DQ", "SUS-MC3_M3_WIT_Y_DQ", "IMC-PZT_YAW_OUT_DQ"]

# list of the error signal channels
readout = ["IMC-WFS_A_I_YAW_OUT_DQ", "IMC-WFS_B_I_YAW_OUT_DQ", "IMC-WFS_A_DC_YAW_OUT_DQ", "IMC-WFS_B_DC_YAW_OUT_DQ", 
           "IMC-MC2_TRANS_YAW_OUT_DQ", "IMC-IM4_TRANS_YAW_OUT_DQ", "IMC-IM4_TRANS_SUM_OUT_DQ"]
