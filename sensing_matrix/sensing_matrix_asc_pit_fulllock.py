...
filename = "asc_sensing_matrix_fulllock_pitch2"

# where are you?
ifo = "H1" 

# list of excitation channels
excitations = ["ASC-INP1_P_EXC", "ASC-PRC1_P_EXC", "ASC-PRC2_P_EXC", "ASC-MICH_P_EXC", "ASC-SRC1_P_EXC", "ASC-SRC2_P_EXC", "ASC-DHARD_P_EXC", "ASC-CHARD_P_EXC"]
# sampling frequency of the excitation channels
fsample = 2048
# list of corresponding excitation frequencies
freqs = [8, 8, 8, 8, 8, 8, 8, 8]
# and of amplitudes
#ampls = [1000000, 10000, 30000000, 100, 300000000, 3, 0, 0]  # amplitudes good for DRMI
ampls =  [100000, 1000, 10000000, 10, 10000000, 0.3, 1, 10]
...
#monitors = ["SUS-IM4_M1_DAMP_P_IN1_DQ", "SUS-PRM_M3_WIT_P_DQ", "SUS-PR2_M3_WIT_P_DQ", 
#            "SUS-BS_M3_OPLEV_PIT_OUT_DQ", "SUS-SRM_M3_WIT_P_DQ", "SUS-SR2_M3_WIT_P_DQ",
#            "SUS-ETMX_L3_OPLEV_PIT_OUT_DQ", "SUS-ETMY_L3_OPLEV_PIT_OUT_DQ"]
monitors = ["ASC-INP1_P_OUT_DQ", "ASC-PRC1_P_OUT_DQ", "ASC-PRC2_P_OUT_DQ", "ASC-MICH_P_OUT_DQ", "ASC-SRC1_P_OUT_DQ", "ASC-SRC2_P_OUT_DQ", "ASC-DHARD_P_OUT_DQ", "ASC-CHARD_P_OUT_DQ"]

# list of the error signal channels
readout = ["ASC-AS_A_DC_PIT_OUT_DQ", "ASC-AS_A_RF36_I_PIT_OUT_DQ", "ASC-AS_A_RF36_Q_PIT_OUT_DQ", "ASC-AS_A_RF45_I_PIT_OUT_DQ", "ASC-AS_A_RF45_Q_PIT_OUT_DQ",
           "ASC-AS_B_DC_PIT_OUT_DQ", "ASC-AS_B_RF36_I_PIT_OUT_DQ", "ASC-AS_B_RF36_Q_PIT_OUT_DQ", "ASC-AS_B_RF45_I_PIT_OUT_DQ", "ASC-AS_B_RF45_Q_PIT_OUT_DQ",
           "ASC-REFL_A_DC_PIT_OUT_DQ", "ASC-REFL_A_RF9_I_PIT_OUT_DQ", "ASC-REFL_A_RF9_Q_PIT_OUT_DQ", "ASC-REFL_A_RF45_I_PIT_OUT_DQ", "ASC-REFL_A_RF45_Q_PIT_OUT_DQ",
           "ASC-REFL_B_DC_PIT_OUT_DQ", "ASC-REFL_B_RF9_I_PIT_OUT_DQ", "ASC-REFL_B_RF9_Q_PIT_OUT_DQ", "ASC-REFL_B_RF45_I_PIT_OUT_DQ", "ASC-REFL_B_RF45_Q_PIT_OUT_DQ",
           "ASC-POP_A_PIT_OUT_DQ", "ASC-POP_B_PIT_OUT_DQ"]
